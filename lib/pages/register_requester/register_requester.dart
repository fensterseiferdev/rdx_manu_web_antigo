...
import '../../locator.dart';
class RegisterRequesterPage extends StatefulWidget {
  @override
  _RegisterRequesterPageState createState() => _RegisterRequesterPageState();
}

class _RegisterRequesterPageState extends State<RegisterRequesterPage> {
              ...
              child: Padding(
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      CustomText(
                        text: 'Cadastramento de requisitante',
                        size: 28,
                        color: strongPurple,
                      ),
                            ...
                            Expanded(
                              child: SizedBox(
                                ...
                                child: TextFormField(
                                  ...
                                  validator: (pass) {
                                    if (pass!.isEmpty) {
                                      return 'Digite uma senha para o requisitante';
