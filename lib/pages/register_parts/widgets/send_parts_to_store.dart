...
class SendPartsToStore extends StatelessWidget {
  final List<SheetPart> sheetParts;
  const SendPartsToStore(this.sheetParts);
  ...
  Widget build(BuildContext context) {
    return Dialog(
      child: Container(
        ...
        child: FutureBuilder(
          future: context.read<CloudFirestoreProvider>().saveSheetParts(sheetParts),
